...
class InventoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inventory" do
    assert_difference("Inventory.count") do
      post inventories_url, params: { inventory: { price: @inventory.price, qty: @inventory.qty } }
    end
  ...
  test "should update inventory" do
    patch inventory_url(@inventory), params: { inventory: { price: @inventory.price, qty: @inventory.qty } }
